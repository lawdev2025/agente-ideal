...
INSERT INTO school_units (id, name, address, phone, whatsapp, hours, levels, system, enrollment_fee, monthly_fee, material_annual, infrastructure, activities, capacity) VALUES
  ('sede',              'Sede (Batista Campos)', 'Rua dos Mundurucus, 1412',      '(91) 3222-0000', '(91) 98888-0000', 'Seg-Sex: 07h-19h / Sáb: 08h-12h', 'Infantil ao Pré-Vestibular (Eixo) e Militares', 'Poliedro', 1800, 1800, 3200, 'Lousas digitais, ginásio, laboratórios, auditório', 'Robótica, Educação Financeira, Esportes', '1.500 alunos'),
  ('augusto-montenegro','Augusto Montenegro',   'Rod. Augusto Montenegro, 130',  '(91) 3333-0000', '(91) 99999-0000', 'Seg-Sex: 07h-18h / Sáb: 08h-12h', 'Educação Infantil ao Ensino Médio', 'Poliedro', 1600, 1600, 2900, 'Parquinho, quadras auxiliares, lab de informática', 'Robótica, Dança, Artes', '1.200 alunos'),
  ('cidade-nova',       'Cidade Nova',          'Av. SN-3, 3277 (Ananindeua)',   '(91) 3444-0000', '(91) 97777-0000', 'Seg-Sex: 07h-18h / Sáb: 08h-12h', 'Educação Infantil ao Ensino Médio', 'Poliedro', 1500, 1500, 2800, 'Brinquedoteca, quadra coberta, lab prático', 'Música, Futsal, Robótica', '1.000 alunos')
ON CONFLICT (id) DO NOTHING;
