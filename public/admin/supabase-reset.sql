...
INSERT INTO school_units (id, name, address, phone, whatsapp, hours, levels, system, infrastructure, activities, capacity, visit_link) VALUES
  ('sede',              'Batista Campos',    'Rua dos Mundurucus, 1412 — Batista Campos, Belém — PA',                                              '(91) 3323-5000', NULL, 'Segunda a sexta, entrada 07:30 com 30 min de tolerância', 'Maternal, Jardim I e II, Fundamental 1, Fundamental 2, Ensino Médio, Pré-Enem (Eixo)', 'Poliedro', 'Quadra coberta, ginásio, campo, piscina, laboratórios, biblioteca, auditório, refeitório, parquinho, brinquedoteca, sala de robótica/maker, sala de música/artes', 'Cursos específicos, Escolinhas de Esporte, NAE a partir de 2027', 'A confirmar', 'https://grupoideal.com.br?quillbooking_calendar=agendamento-ideal-batista-campos&event=visita-ideal-batista-campos'),
  ('augusto-montenegro','Augusto Montenegro',       'Rodovia Augusto Montenegro, 130 — Parque Verde, Belém — PA',                                         '(91) 3120-3188', NULL, 'Segunda a sexta, entrada 07:30 com 30 min de tolerância', 'Maternal, Jardim I e II, Fundamental 1, Fundamental 2, Ensino Médio, Pré-Enem (Eixo)', 'Poliedro', 'Quadra coberta, ginásio, campo, piscina, laboratórios, biblioteca, auditório, refeitório, parquinho, brinquedoteca, sala de robótica/maker, sala de música/artes', 'Cursos específicos, Escolinhas de Esporte, NAE a partir de 2027', 'A confirmar', 'https://grupoideal.com.br?quillbooking_calendar=agendamento-ideal-augusto-montenegro&event=visita-ideal-augusto-montenegro'),
  ('cidade-nova',       'Cidade Nova (Ananindeua)', 'Conjunto Cidade Nova II, Av. SN-3, nº 3277 (esquina com a WE-21) — Coqueiro, Ananindeua — PA',       '(91) 3346-0011', NULL, 'Segunda a sexta, entrada 07:30 com 30 min de tolerância', 'Maternal, Jardim I e II, Fundamental 1, Fundamental 2, Ensino Médio, Pré-Enem (Eixo)', 'Poliedro', 'Quadra coberta, ginásio, campo, piscina, laboratórios, biblioteca, auditório, refeitório, parquinho, brinquedoteca, sala de robótica/maker, sala de música/artes', 'Cursos específicos, Escolinhas de Esporte, NAE a partir de 2027', 'A confirmar', 'https://grupoideal.com.br?quillbooking_calendar=agendamento-ideal-cidade-nova&event=visita-ideal-cidade-nova')
ON CONFLICT (id) DO NOTHING;
